...
# desktop 文件信息
DESKTOP_FILE="skynet.desktop"
DESKTOP_PATH="resources/applications/$DESKTOP_FILE"
DESKTOP_URL="https://raw.githubusercontent.com/$OWNER/$REPO/$BRANCH/$DESKTOP_PATH"
DESKTOP_MODE="0644"
DESKTOP_OWNER="root"
DESKTOP_GROUP="root"
DESKTOP_FILE_PATH="/usr/local/share/applications"
# icon 文件信息
ICON_FILE="skynet.png"
ICON_PATH="resources/pixmaps/$ICON_FILE"
ICON_URL="https://raw.githubusercontent.com/$OWNER/$REPO/$BRANCH/$ICON_PATH"
ICON_MODE="0644"
ICON_OWNER="root"
ICON_GROUP="root"
ICON_FILE_PATH="/usr/local/share/pixmaps"
# LICENSE 文件信息
...
function installer() { # 安装程序
  ...
  checkpath "$DESKTOP_FILE_PATH"
  install --mode="$DESKTOP_MODE" --owner="$DESKTOP_OWNER" --group="$DESKTOP_GROUP" "$DESKTOP_FILE" "$DESKTOP_FILE_PATH/$DESKTOP_FILE"
  checkpath "$ICON_FILE_PATH"
  install --mode="$ICON_MODE" --owner="$ICON_OWNER" --group="$ICON_GROUP" "$ICON_FILE" "$ICON_FILE_PATH/$ICON_FILE"
